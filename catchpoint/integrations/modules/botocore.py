...
from catchpoint.integrations.modules.requests import _wrapper as request_wrapper

import catchpoint.integrations.botocore
...
def patch():
    if not ConfigProvider.get(config_names.CATCHPOINT_TRACE_INTEGRATIONS_AWS_DISABLE):
