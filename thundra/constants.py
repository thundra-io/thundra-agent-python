...
THUNDRA_DISABLE = 'thundra_agent_disable'
THUNDRA_APPLICATION_DOMAIN_NAME = 'thundra_agent_application_domainName'
THUNDRA_APPLICATION_CLASS_NAME = 'thundra_agent_application_className'
THUNDRA_APPLICATION_STAGE = 'thundra_agent_application_stage'
THUNDRA_APPLICATION_VERSION = 'thundra_agent_application_version'
THUNDRA_AGENT_VERSION = '2.4.1'

LAMBDA_APPLICATION_DOMAIN_NAME = 'API'
LAMBDA_APPLICATION_CLASS_NAME = 'AWS-Lambda'
LAMBDA_APPLICATION_PLATFORM = 'AWS Lambda'
THUNDRA_LAMBDA_TIMEOUT_MARGIN = 'thundra_agent_timeout_margin'
THUNDRA_LAMBDA_REPORT_REST_BASEURL = 'thundra_agent_report_rest_baseUrl'
THUNDRA_LAMBDA_REPORT_REST_COMPOSITE_ENABLED = 'thundra_agent_report_rest_composite_enable'
THUNDRA_LAMBDA_REPORT_CLOUDWATCH_ENABLE = 'thundra_agent_report_cloudwatch_enable'
THUNDRA_LAMBDA_REPORT_CLOUDWATCH_COMPOSITE_ENABLED = 'thundra_agent_report_cloudwatch_composite_enable'
THUNDRA_LAMBDA_WARMUP_AWARE = 'thundra_agent_warmup_warmupAware'

THUNDRA_DISABLE_TRACE = 'thundra_agent_trace_disable'
THUNDRA_DISABLE_METRIC = 'thundra_agent_metric_disable'
THUNDRA_DISABLE_LOG = 'thundra_agent_log_disable'

THUNDRA_LAMBDA_TRACE_REQUEST_SKIP = 'thundra_agent_trace_request_skip'
THUNDRA_LAMBDA_TRACE_RESPONSE_SKIP = 'thundra_agent_trace_response_skip'
THUNDRA_LAMBDA_TRACE_INSTRUMENT_DISABLE = 'thundra_agent_trace_instrument_disable'
THUNDRA_LAMBDA_TRACE_INSTRUMENT_CONFIG = 'thundra_agent_trace_instrument_traceableConfig'
THUNDRA_LAMBDA_TRACE_ENABLE_XRAY = 'thundra_agent_trace_enable_xray'
...
THUNDRA_LAMBDA_TRACE_KINESIS_REQUEST_ENABLE = 'thundra_agent_trace_kinesis_request_enable'
THUNDRA_LAMBDA_TRACE_FIREHOSE_REQUEST_ENABLE = 'thundra_agent_trace_firehose_request_enable'
THUNDRA_LAMBDA_TRACE_CLOUDWATCHLOG_REQUEST_ENABLE = 'thundra_agent_trace_cloudwatchlog_request_enable'

THUNDRA_AGENT_METRIC_TIME_AWARE_SAMPLER_TIME_FREQ = 'thundra_agent_metric_sample_sampler_timeAware_timeFreq'
THUNDRA_AGENT_METRIC_COUNT_AWARE_SAMPLER_COUNT_FREQ = 'thundra_agent_metric_sample_sampler_countAware_countFreq'
DEFAULT_METRIC_SAMPLING_TIME_FREQ = 5 * 60 * 1000
DEFAULT_METRIC_SAMPLING_COUNT_FREQ = 100

THUNDRA_DISABLE_HTTP_INTEGRATION = 'thundra_agent_trace_integrations_http_disable'
THUNDRA_DISABLE_RDB_INTEGRATION = 'thundra_agent_trace_integrations_rdb_disable'
THUNDRA_DISABLE_AWS_INTEGRATION = 'thundra_agent_trace_integrations_aws_disable'
THUNDRA_DISABLE_REDIS_INTEGRATION = 'thundra_agent_trace_integrations_redis_disable'
THUNDRA_DISABLE_ES_INTEGRATION = 'thundra_agent_trace_integrations_elasticsearch_disable'
THUNDRA_DISABLE_MONGO_INTEGRATION = 'thundra_agent_trace_integrations_mongodb_disable'
THUNDRA_DISABLE_SQLALCHEMY_INTEGRATION = 'thundra_agent_trace_integrations_sqlalchemy_disable'
THUNDRA_DISABLE_CHALICE_INTEGRATION = 'thundra_agent_trace_integrations_chalice_disable'
THUNDRA_HTTP_ERROR_STATUS_CODE_MIN = 'thundra_agent_trace_integrations_http_error_status_code_min'

THUNDRA_MASK_REDIS_COMMAND = 'thundra_agent_trace_integrations_redis_command_mask'
THUNDRA_MASK_RDB_STATEMENT = 'thundra_agent_trace_integrations_rdb_statement_mask'
THUNDRA_MASK_DYNAMODB_STATEMENT = 'thundra_agent_trace_integrations_aws_dynamodb_statement_mask'
THUNDRA_MASK_ATHENA_STATEMENT = 'thundra_agent_trace_integrations_aws_athena_statement_mask'
THUNDRA_MASK_ES_BODY = 'thundra_agent_trace_integrations_elasticsearch_body_mask'
THUNDRA_MASK_MONGODB_COMMAND = 'thundra_agent_trace_integrations_mongodb_command_mask'
THUNDRA_MASK_SNS_MESSAGE = 'thundra_agent_trace_integrations_aws_sns_message_mask'
THUNDRA_MASK_SQS_MESSAGE = 'thundra_agent_trace_integrations_aws_sqs_message_mask'
THUNDRA_MASK_LAMBDA_PAYLOAD = 'thundra_agent_trace_integrations_aws_lambda_payload_mask'
THUNDRA_MASK_HTTP_BODY = 'thundra_agent_trace_integrations_aws_http_body_mask'
...
APPLICATION_ID_PROP_NAME = 'thundra_agent_application_id'
APPLICATION_DOMAIN_NAME_PROP_NAME = 'thundra_agent_application_domainName'
APPLICATION_CLASS_NAME_PROP_NAME = 'thundra_agent_application_className'
APPLICATION_NAME_PROP_NAME = 'thundra_agent_application_name'
APPLICATION_VERSION_PROP_NAME = 'thundra_agent_application_version'
APPLICATION_STAGE_PROP_NAME = 'thundra_agent_application_stage'
APPLICATION_TAG_PROP_NAME_PREFIX = 'thundra_agent_application_tag_'
...
THUNDRA_LAMBDA_DEBUG_ENABLE = 'thundra_agent_debug_enable'
THUNDRA_LAMBDA_LOG_CONSOLE_PRINT_DISABLE = 'thundra_agent_log_console_disable'
THUNDRA_LAMBDA_SPAN_LISTENER = 'thundra_agent_trace_span_listenerConfig'
...
THUNDRA_LAMBDA_REPORT_REST_COMPOSITE_BATCH_SIZE = 'thundra_agent_report_rest_composite_batchsize'
THUNDRA_LAMBDA_REPORT_CLOUDWATCH_COMPOSITE_BATCH_SIZE = 'thundra_agent_report_cloudwatch_composite_batchsize'
...
THUNDRA_AGENT_TRACE_INTEGRATIONS_HTTP_URL_DEPTH = "thundra_agent_trace_integrations_http_url_depth"
THUNDRA_AGENT_TRACE_INTEGRATIONS_ELASTICSEARCH_PATH_DEPTH = "thundra_agent_trace_integrations_elasticsearch_path_depth"
