...
APPLICATION_ID_PROP_NAME = 'thundra.agent.application.id'
APPLICATION_DOMAIN_NAME_PROP_NAME = 'thundra.agent.application.domainName'
APPLICATION_CLASS_NAME_PROP_NAME = 'thundra.agent.application.className'
APPLICATION_NAME_PROP_NAME = 'thundra.agent.application.name'
APPLICATION_VERSION_PROP_NAME = 'thundra.agent.application.version'
APPLICATION_STAGE_PROP_NAME = 'thundra.agent.application.stage'
APPLICATION_TAG_PROP_NAME_PREFIX = 'thundra.agent.application.tag.'
