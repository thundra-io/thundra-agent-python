class ApplicationInfo:
    ...
    def __init__(self, application_id = None, application_instance_id = None, application_domain_name = None,
         ...
         application_stage = None, application_region = None, application_runtime = None, 
        ...
        self.application_region = application_region 
    ...
    def to_json(self):
        return {
            ...
            'applicationRegion': self.application_region,
